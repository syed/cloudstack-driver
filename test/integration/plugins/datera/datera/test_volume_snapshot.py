...
class TestPrimaryStorage(cloudstackTestCase):
    ...
    def test14_volume_snapshot_create(self):
        ...
        print "self.testdata ===== " + str(self.testdata)
        print "self.disk_offering ===== " + str(self.disk_offering.__dict__)
        ...
        Snapshot.delete(snapshot_created, self.apiClient)

        return

    def test15_volume_snapshot_policy(self):
        primarystorage = self.testdata[TestData.primaryStorage]
