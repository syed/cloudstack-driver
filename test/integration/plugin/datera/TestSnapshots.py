...
logger = logging.getLogger('datera')
hdlr = logging.FileHandler('/var/tmp/datera.log')
...
class TestData():
    ...
    def __init__(self):
        self.testdata = {
            TestData.Datera: {
                TestData.mvip: "172.30.8.20",
                TestData.login: "tenant4admin",
            ...
            TestData.primaryStorage: {
                ...
                TestData.scope: "ZONE",
                "url": "mVip=172.30.8.20;sVip=172.30.8.21;" +
                       "clusterAdminUsername=tenant4admin;clusterAdminPassword=password;" +
                       "clusterDefaultMinIops=10000;clusterDefaultMaxIops=15000;" +
                       "ipPool=default;numReplicas=1;",
...
class TestSnapshots(cloudstackTestCase):
    ...
    def setUpClass(cls):
        ...
        cls.dt_client = get_api(
            datera[TestData.mvip],
            datera[TestData.login],
            datera[TestData.password],
            datera[TestData.version],
            datera[TestData.tenant]
        )
